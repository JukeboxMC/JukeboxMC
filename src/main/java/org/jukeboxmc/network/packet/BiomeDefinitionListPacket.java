...
public class BiomeDefinitionListPacket extends Packet {
    ...
    public void write() {
        super.write();
        this.writeBytes( Base64.getDecoder().decode( this.hardCoded ) );
    }
}
