...
public enum ItemType {
    ...
    ACACIA_LEAVES( BlockType.ACACIA_LEAVES.toItem() ),
    DARK_OAK_LEAVES( BlockType.DARK_OAK_LEAVES.toItem() ),

    ACACIA_LOG( BlockType.ACACIA_LOG.toItem() ),
    DARK_OAK_LOG( BlockType.DARK_OAK_LOG.toItem() ),
    ...
    MANGROVE_LOG( new ItemMangroveLog() ),
    STRIPPED_MANGROVE_LOG( new ItemStrippedMangroveLog() ),
    MANGROVE_PLANKS( new ItemMangrovePlanks() ),
    MANGROVE_FENCE( new ItemMangroveFence() ),
    MANGROVE_FENCE_GATE( new ItemMangroveFenceGate() ),
    MANGROVE_STAIRS( new ItemMangroveStairs() ),
    MANGROVE_DOOR( new ItemMangroveDoor() ),
    MANGROVE_TRAPDOOR( new ItemMangroveTrapdoor() ),
    MANGROVE_WOOD( new ItemMangroveWood() ),
    STRIPPED_MANGROVE_WOOD( new ItemStrippedMangroveWood() ),
    MANGROVE_BUTTON( new ItemMangroveButton() ),
    MANGROVE_PRESSURE_PLATE( new ItemMangrovePressurePlate() ),
    MANGROVE_ROOTS( new ItemMangroveRoots() ),
    MANGROVE_SIGN( new ItemMangroveSign() ),
    MUDDY_MANGROVE_ROOTS( new ItemMuddyMangroveRoots() ),
    ECHO_SHARD( new ItemEchoShard() ),
    GOAT_HORN( new ItemGoatHorn() ),
    RECOVERY_COMPASS( new ItemRecoveryCompass() ),
    DISC_FRAGMENT( new ItemDiscFragment() ),
    MANGROVE_BOAT( new ItemMangroveBoat() ),
    MUSIC_DISC_5( new ItemMusicDisc5() );
