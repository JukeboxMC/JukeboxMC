 ...
 * @version 1.0
 */
public class ItemLeatherLeggings extends ItemArmor implements Durability {

    public ItemLeatherLeggings( ItemType itemType ) {
        super( itemType );
    }

    public ItemLeatherLeggings( Identifier identifier ) {
        super( identifier );
    }
