 ...
 * @version 1.0
 */
public class ItemGoldenHelmet extends ItemArmor implements Durability {

    public ItemGoldenHelmet( ItemType itemType ) {
        super( itemType );
    }

    public ItemGoldenHelmet( Identifier identifier ) {
        super( identifier );
    }
