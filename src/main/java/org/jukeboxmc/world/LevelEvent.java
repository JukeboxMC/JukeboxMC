...
public enum LevelEvent {
    ...
    PARTICLE_LAVA( 16393 ),
    PARTICLE_LARGE_SMOKE( 16394 ),
    PARTICLE_REDSTONE( 16395 ),
    PARTICLE_RISING_RED_DUST( 16396 ),
    PARTICLE_ITEM_BREAK( 16397 ),
    PARTICLE_SNOWBALL_POOF( 16398 ),
    PARTICLE_HUGE_EXPLODE( 16399 ),
    PARTICLE_HUGE_EXPLODE_SEED( 16400 ),
    PARTICLE_MOB_FLAME( 16401 ),
    PARTICLE_HEART( 16402 ),
    PARTICLE_TERRAIN( 16403 ),
    PARTICLE_TOWN_AURA( 16404 ),
    PARTICLE_PORTAL( 16405 ),
    PARTICLE_MOB_PORTAL( 16406 ),
    PARTICLE_SPLASH( 16407 ),
    PARTICLE_SPLASH_MANUAL( 16408 ),
    PARTICLE_WATER_WAKE( 16409 ),
    PARTICLE_DRIP_WATER( 16410 ),
    PARTICLE_DRIP_LAVA( 16411 ),
    PARTICLE_DRIP_HONEY( 16412 ),
    PARTICLE_STALACTITE_DRIP_WATER( 16413 ),
    PARTICLE_STALACTITE_DRIP_LAVA( 16414 ),
    PARTICLE_FALLING_DUST( 16415 ),
    PARTICLE_MOB_SPELL( 16416 ),
    PARTICLE_MOB_SPELL_AMBIENT( 16417 ),
    PARTICLE_MOB_SPELL_INSTANTANEOUS( 16418 ),
    PARTICLE_INK( 16419 ),
    PARTICLE_SLIME( 16420 ),
    PARTICLE_RAIN_SPLASH( 16421 ),
    PARTICLE_VILLAGER_ANGRY( 16422 ),
    PARTICLE_VILLAGER_HAPPY( 16423 ),
    PARTICLE_ENCHANTMENT_TABLE( 16424 ),
    PARTICLE_TRACKING_EMITTER( 16425 ),
    PARTICLE_NOTE( 16426 ),
    PARTICLE_WITCH_SPELL( 16427 ),
    PARTICLE_CARROT( 16428 ),
    PARTICLE_MOB_APPEARANCE( 16429 ),
    PARTICLE_END_ROD( 16430 ),
    PARTICLE_SPIT( 16432 ),
    PARTICLE_TOTEM( 16433 ),
    PARTICLE_FOOD( 16434 ),
    PARTICLE_FIREWORKS_STARTER( 16435 ),
    PARTICLE_FIREWORKS_SPARK( 16436 ),
    PARTICLE_FIREWORKS_OVERLAY( 16437 ),
    PARTICLE_BALLOON_GAS( 16438 ),
    PARTICLE_COLORED_FLAME( 16439 ),
    PARTICLE_SPARKLER( 16440 ),
    PARTICLE_CONDUIT( 16441 ),
    PARTICLE_BUBBLE_COLUMN_UP( 16442 ),
    PARTICLE_BUBBLE_COLUMN_DOWN( 16443 ),
    PARTICLE_SNEEZE( 16444 ),
    PARTICLE_SHULKER_BULLET( 16445 ),
    PARTICLE_BLEACH( 16446 ),
    PARTICLE_DRAGON_DESTROY_BLOCK( 16447 ),
    PARTICLE_MYCELIUM_DUST( 16448 ),
    PARTICLE_FALLING_RED_DUST( 16449 ),
    PARTICLE_CAMPFIRE_SMOKE( 16450 ),
    PARTICLE_TALL_CAMPFIRE_SMOKE( 16451 ),
    PARTICLE_RISING_DRAGONS_BREATH( 16452 ),
    PARTICLE_DRAGONS_BREATH( 16453 ),
    PARTICLE_BLUE_FLAME( 16454 ),
    PARTICLE_SOUL( 16455 ),
    PARTICLE_OBSIDIAN_TEAR( 16456 );
