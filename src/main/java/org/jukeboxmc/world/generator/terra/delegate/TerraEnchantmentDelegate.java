 ...
 * @version 1.0
 */
public record TerraEnchantmentDelegate(Enchantment enchantment) implements com.dfsek.terra.api.inventory.item.Enchantment {
    ...
    @Override
    public boolean conflictsWith( com.dfsek.terra.api.inventory.item.Enchantment enchantment ) {
        return false;
    }
    ...
    public String getID() {
        return switch (enchantment.getId()) {
            ...
            case 36 -> "soul_speed";
            default -> throw new IllegalStateException("Unexpected enchantment id: " + enchantment.getId());
        };
    }
