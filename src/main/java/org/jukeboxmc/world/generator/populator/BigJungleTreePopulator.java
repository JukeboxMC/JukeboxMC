...
import org.jukeboxmc.world.generator.object.tree.BigJungleTree;
 ...
 * @version 1.0
 */
public class BigJungleTreePopulator extends Populator {
    ...
    public void populate(@NotNull Random random, World world, @NotNull PopulationChunkManager chunkManager, int chunkX, int chunkZ ) {
        ...
        for ( int i = 0; i < amount; ++i ) {
            ...
            new BigJungleTree( 10, 20 ).create( random, chunkManager, new Vector( x, y, z ) );
        }
    }
