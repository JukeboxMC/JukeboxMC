...
public class AdventureSettings {
    ...
    public void update() {
        ...
        if ( this.worldImmutable ) {
            flags |= AdventureType.FirstFlag.WORLD_IMMUTABLE.getId();              // Immutable World (Remove hit markers client-side).
        }

        if ( this.noPvP ) {
            flags |= AdventureType.FirstFlag.NO_PVP.getId();              // No PvP (Remove hit markers client-side).
        }
        ...
        if ( this.noClip ) {
            flags |= AdventureType.FirstFlag.NO_CLIP.getId();              // No clip
        }
        ...
        if ( this.flying ) {
            flags |= AdventureType.FirstFlag.FLYING.getId();             // Set flying
        }
