...
public enum BlockType {
    ...
    UNPOWERED_REPEATER( BlockRepeater.class ),
    ...
    FENCE_GATE( BlockOakFenceGate.class ),
    ...
    UNPOWERED_COMPARATOR( BlockCompartor.class ),
    ...
    ACACIA_LEAVES( BlockLeaves2.class ),
    ACACIA_LOG( BlockLog2.class ),
    ...
    DOUBLE_RED_SANDSTONE_SLAB( BlockDoubleStoneSlab2.class ),
    RED_SANDSTONE_SLAB( BlockStoneSlab2.class ),
    ...
    PURPUR_STAIRS( BlockPurpurStairs.class ),
    ...
    END_STONE_BRICK_SLAB( BlockStoneSlab3.class ),
    BAMBOO( BlockBamboo.class ),
    BAMBOO_SAPLING( BlockBambooSapling.class ),
    SCAFFOLDING( BlockScaffolding.class ),
    MOSSY_STONE_BRICK_SLAB( BlockStoneSlab4.class ),
    DOUBLE_END_STONE_BRICK_SLAB( BlockDoubleStoneSlab3.class ),
    DOUBLE_MOSSY_STONE_BRICK_SLAB( BlockDoubleStoneSlab4.class ),
    ...
    CRIMSON_DOUBLE_SLAB( BlockDoubleCrimsonSlab.class ),
    WARPED_DOUBLE_SLAB( BlockDoubleWarpedSlab.class ),
    ...
    BLACKSTONE_DOUBLE_SLAB( BlockDoubleBlackstoneSlab.class ),
    ...
    POLISHED_BLACKSTONE_DOUBLE_SLAB( BlockDoublePolishedBlackstoneSlab.class ),
