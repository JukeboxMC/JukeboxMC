...
public enum BlockType {
    ...
    STONE_SLAB3( BlockStoneSlab3.class ),
    BAMBOO( BlockBamboo.class ),
    BAMBOO_SAPLING( BlockBambooSapling.class ),
    SCAFFOLDING( BlockScaffolding.class ),
    STONE_SLAB4( BlockStoneSlab4.class ),
    DOUBLE_STONE_SLAB3( BlockDoubleStoneSlab3.class ),
    DOUBLE_STONE_SLAB4( BlockDoubleStoneSlab4.class ),
