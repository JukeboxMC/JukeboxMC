 ...
 * @version 1.0
 */
public class BlockOakStandingSign extends BlockSign {

    public BlockOakStandingSign( Identifier identifier ) {
        super( identifier );
    }

    public BlockOakStandingSign( Identifier identifier, NbtMap blockStates ) {
    ...
    public boolean placeBlock( Player player, World world, Vector blockPosition, Vector placePosition, Vector clickedPosition, Item itemInHand, BlockFace blockFace ) {
        if ( blockFace == BlockFace.UP ) {
            ...
            BlockOakWallSign blockWallSign = Block.create( BlockType.OAK_WALL_SIGN );
