...
public class BlockMangroveStandingSign extends BlockSign{
    ...
    public BlockMangroveStandingSign( Identifier identifier ) {
        super( identifier );
    }

    public BlockMangroveStandingSign( Identifier identifier, NbtMap blockStates ) {
    ...
    public boolean placeBlock( Player player, World world, Vector blockPosition, Vector placePosition, Vector clickedPosition, Item itemInHand, BlockFace blockFace ) {
        ...
        if ( blockFace == BlockFace.UP ) {
            ...
            BlockMangroveWallSign blockWallSign = Block.create( BlockType.MANGROVE_WALL_SIGN );
