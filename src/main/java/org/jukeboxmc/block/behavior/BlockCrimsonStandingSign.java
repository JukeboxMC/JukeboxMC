...
public class BlockCrimsonStandingSign extends BlockSign {
    ...
    public BlockCrimsonStandingSign( Identifier identifier ) {
        super( identifier );
    }

    public BlockCrimsonStandingSign( Identifier identifier, NbtMap blockStates ) {
    ...
    public boolean placeBlock(@NotNull Player player, @NotNull World world, Vector blockPosition, @NotNull Vector placePosition, Vector clickedPosition, Item itemInHand, @NotNull BlockFace blockFace ) {
        ...
        if ( blockFace == BlockFace.UP ) {
            ...
            BlockCrimsonWallSign blockWallSign = Block.create( BlockType.CRIMSON_WALL_SIGN );
