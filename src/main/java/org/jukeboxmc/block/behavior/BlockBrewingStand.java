...
public class BlockBrewingStand extends Block {
    ...
    public boolean isBrewingStandSlotA() {
        return this.stateExists( "brewing_stand_slot_a_bit" ) && this.getIntState( "brewing_stand_slot_a_bit" ) == 1;
    }
    ...
    public boolean isBrewingStandSlotB() {
        return this.stateExists( "brewing_stand_slot_b_bit" ) && this.getIntState( "brewing_stand_slot_b_bit" ) == 1;
    }
    ...
    public boolean isBrewingStandSlotC() {
        return this.stateExists( "brewing_stand_slot_c_bit" ) && this.getIntState( "brewing_stand_slot_c_bit" ) == 1;
    }
}
