 ...
 * @version 1.0
 */
public class BlockBirchStandingSign extends BlockSign {

    public BlockBirchStandingSign( Identifier identifier ) {
        super( identifier );
    }

    public BlockBirchStandingSign( Identifier identifier, NbtMap blockStates ) {
    ...
    public boolean placeBlock(@NotNull Player player, @NotNull World world, Vector blockPosition, @NotNull Vector placePosition, Vector clickedPosition, Item itemInHand, @NotNull BlockFace blockFace ) {
        ...
        if ( blockFace == BlockFace.UP ) {
            ...
            BlockBirchWallSign blockWallSign = Block.create( BlockType.BIRCH_WALL_SIGN );
