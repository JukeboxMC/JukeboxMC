...
public class BlockSpruceStandingSign extends BlockSign{
    ...
    public BlockSpruceStandingSign( Identifier identifier ) {
        super( identifier );
    }

    public BlockSpruceStandingSign( Identifier identifier, NbtMap blockStates ) {
    ...
    public boolean placeBlock( Player player, World world, Vector blockPosition, Vector placePosition, Vector clickedPosition, Item itemInHand, BlockFace blockFace ) {
        ...
        if ( blockFace == BlockFace.UP ) {
            ...
            BlockSpruceWallSign blockWallSign = Block.create( BlockType.SPRUCE_WALL_SIGN );
