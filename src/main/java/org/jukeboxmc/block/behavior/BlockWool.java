...
import org.jukeboxmc.item.behavior.ItemWool;
...
public class BlockWool extends Block {
    ...
    public BlockWool( Identifier identifier, NbtMap blockStates ) {
        super( identifier, blockStates );
    }

    @Override
    public Item toItem() {
        return Item.<ItemWool>create( ItemType.WOOL ).setColor( this.getColor() );
    }
