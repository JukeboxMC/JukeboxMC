...
public class BlockEmeraldOre extends Block {
    ...
    public BlockEmeraldOre( Identifier identifier ) {
        super( identifier );
    }

    public BlockEmeraldOre( Identifier identifier, NbtMap blockStates ) {
    ...
    public List<Item> getDrops( Item item ) {
        if ( this.isCorrectToolType( item ) && this.isCorrectTierType( item ) ) {
            ...
            return Collections.singletonList( Item.create( ItemType.EMERALD ).setAmount( amount ) );
        }
