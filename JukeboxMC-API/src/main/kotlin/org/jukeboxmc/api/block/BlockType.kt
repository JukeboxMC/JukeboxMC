...
enum class BlockType {
    ...
    fun isStainedGlass(): Boolean = this.name.endsWith("_STAINED_GLASS")

    fun isLeaves(): Boolean = this.name.endsWith("LEAVES")

    fun isStainedGlassPane(): Boolean = this.name.endsWith("_STAINED_GLASS_PANE")
