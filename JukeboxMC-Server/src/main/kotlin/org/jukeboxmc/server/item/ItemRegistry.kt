...
class ItemRegistry {
    ...
    companion object {
        ...
        init {
            ...
            register(ItemType.STONE_BLOCK_SLAB, Identifier.fromString("minecraft:stone_block_slab"), ItemStoneBlockSlab::class.java)
            register(ItemType.STONE_BLOCK_SLAB2, Identifier.fromString("minecraft:stone_block_slab2"), ItemStoneBlockSlab2::class.java)
            register(ItemType.STONE_BLOCK_SLAB3, Identifier.fromString("minecraft:stone_block_slab3"), ItemStoneBlockSlab3::class.java)
            register(ItemType.STONE_BLOCK_SLAB4, Identifier.fromString("minecraft:stone_block_slab4"), ItemStoneBlockSlab4::class.java)
