...
class ItemRegistry {
    ...
    companion object {
        ...
        init {
            ...
            register(ItemType.ARMADILLO_SCUTE, Identifier.fromString("minecraft:armadillo_scute"))
            register(ItemType.ARMADILLO_SPAWN_EGG, Identifier.fromString("minecraft:armadillo_spawn_egg"))
            ...
            register(ItemType.BEE_NEST, Identifier.fromString("minecraft:bee_nest"), ItemBeeNest::class.java)
            ...
            register(ItemType.BLACK_CARPET, Identifier.fromString("minecraft:black_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.BLACK_WOOL, Identifier.fromString("minecraft:black_wool"), ItemWool::class.java)
            ...
            register(ItemType.BLUE_CARPET, Identifier.fromString("minecraft:blue_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.BLUE_ORCHID, Identifier.fromString("minecraft:blue_orchid"))
            ...
            register(ItemType.BROWN_CARPET, Identifier.fromString("minecraft:brown_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.BROWN_WOOL, Identifier.fromString("minecraft:brown_wool"), ItemWool::class.java)
            ...
            register(ItemType.CARPET, Identifier.fromString("minecraft:carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.COMPOSTER, Identifier.fromString("minecraft:composter"), ItemComposter::class.java)
            ...
            register(ItemType.COPPER_DOOR, Identifier.fromString("minecraft:copper_door"))
            register(ItemType.COPPER_GRATE, Identifier.fromString("minecraft:copper_grate"))
            ...
            register(ItemType.COPPER_TRAPDOOR, Identifier.fromString("minecraft:copper_trapdoor"))
            ...
            register(ItemType.EXPOSED_COPPER_BULB, Identifier.fromString("minecraft:exposed_copper_bulb"))
            register(ItemType.EXPOSED_COPPER_DOOR, Identifier.fromString("minecraft:exposed_copper_door"))
            register(ItemType.EXPOSED_COPPER_GRATE, Identifier.fromString("minecraft:exposed_copper_grate"))
            register(ItemType.EXPOSED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:exposed_copper_trapdoor"))
            ...
            register(ItemType.GRAY_CARPET, Identifier.fromString("minecraft:gray_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.GRAY_WOOL, Identifier.fromString("minecraft:gray_wool"), ItemWool::class.java)
            ...
            register(ItemType.GREEN_CARPET, Identifier.fromString("minecraft:green_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.LARGE_FERN, Identifier.fromString("minecraft:large_fern"))
            ...
            register(ItemType.LIME_CARPET, Identifier.fromString("minecraft:lime_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.LIME_WOOL, Identifier.fromString("minecraft:lime_wool"), ItemWool::class.java)
            ...
            register(ItemType.LOOM, Identifier.fromString("minecraft:loom"), ItemLoom::class.java)
            ...
            register(ItemType.MAGENTA_CARPET, Identifier.fromString("minecraft:magenta_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.MUSIC_DISC_PRECIPICE, Identifier.fromString("minecraft:music_disc_precipice"))
            ...
            register(ItemType.OAK_BOAT, Identifier.fromString("minecraft:oak_boat"), ItemBoat::class.java)
            ...
            register(ItemType.OAK_SAPLING, Identifier.fromString("minecraft:oak_sapling"), ItemSapling::class.java)
            register(ItemType.OAK_SIGN, Identifier.fromString("minecraft:oak_sign"), ItemSign::class.java)
            register(ItemType.OAK_SLAB, Identifier.fromString("minecraft:oak_slab"), ItemWoodenSlab::class.java)
            register(ItemType.OAK_STAIRS, Identifier.fromString("minecraft:oak_stairs"), ItemWoodenStairs::class.java)
            ...
            register(ItemType.ORANGE_CARPET, Identifier.fromString("minecraft:orange_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.ORANGE_TULIP, Identifier.fromString("minecraft:orange_tulip"))
            register(ItemType.ORANGE_WOOL, Identifier.fromString("minecraft:orange_wool"), ItemWool::class.java)
            register(ItemType.OXEYE_DAISY, Identifier.fromString("minecraft:oxeye_daisy"))
            register(ItemType.OXIDIZED_CHISELED_COPPER, Identifier.fromString("minecraft:oxidized_chiseled_copper"))
            register(ItemType.OXIDIZED_COPPER, Identifier.fromString("minecraft:oxidized_copper"))
            register(ItemType.OXIDIZED_COPPER_BULB, Identifier.fromString("minecraft:oxidized_copper_bulb"))
            register(ItemType.OXIDIZED_COPPER_DOOR, Identifier.fromString("minecraft:oxidized_copper_door"))
            register(ItemType.OXIDIZED_COPPER_GRATE, Identifier.fromString("minecraft:oxidized_copper_grate"))
            register(ItemType.OXIDIZED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:oxidized_copper_trapdoor"))
            ...
            register(ItemType.PINK_TULIP, Identifier.fromString("minecraft:pink_tulip"))
            register(ItemType.PINK_WOOL, Identifier.fromString("minecraft:pink_wool"), ItemWool::class.java)
            ...
            register(ItemType.PLANKS, Identifier.fromString("minecraft:planks"))
            ...
            register(ItemType.POLISHED_TUFF_SLAB, Identifier.fromString("minecraft:polished_tuff_slab"))
            register(ItemType.POLISHED_TUFF_STAIRS, Identifier.fromString("minecraft:polished_tuff_stairs"))
            register(ItemType.POLISHED_TUFF_WALL, Identifier.fromString("minecraft:polished_tuff_wall"))
            register(ItemType.POPPED_CHORUS_FRUIT, Identifier.fromString("minecraft:popped_chorus_fruit"))
            register(ItemType.POPPY, Identifier.fromString("minecraft:poppy"))
            ...
            register(ItemType.PURPLE_CARPET, Identifier.fromString("minecraft:purple_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.RED_CARPET, Identifier.fromString("minecraft:red_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.RED_TULIP, Identifier.fromString("minecraft:red_tulip"))
            register(ItemType.RED_WOOL, Identifier.fromString("minecraft:red_wool"), ItemWool::class.java)
            ...
            register(ItemType.SCAFFOLDING, Identifier.fromString("minecraft:scaffolding"), ItemScaffolding::class.java)
            ...
            register(ItemType.SUNFLOWER, Identifier.fromString("minecraft:sunflower"))
            ...
            register(ItemType.TRIAL_SPAWNER, Identifier.fromString("minecraft:trial_spawner"))
            ...
            register(ItemType.TUFF_BRICK_STAIRS, Identifier.fromString("minecraft:tuff_brick_stairs"))
            register(ItemType.TUFF_BRICK_WALL, Identifier.fromString("minecraft:tuff_brick_wall"))
            register(ItemType.TUFF_BRICKS, Identifier.fromString("minecraft:tuff_bricks"))
            register(ItemType.TUFF_DOUBLE_SLAB, Identifier.fromString("minecraft:tuff_double_slab"))
            register(ItemType.TUFF_SLAB, Identifier.fromString("minecraft:tuff_slab"))
            ...
            register(ItemType.WAXED_COPPER_BULB, Identifier.fromString("minecraft:waxed_copper_bulb"))
            register(ItemType.WAXED_COPPER_DOOR, Identifier.fromString("minecraft:waxed_copper_door"))
            register(ItemType.WAXED_COPPER_GRATE, Identifier.fromString("minecraft:waxed_copper_grate"))
            register(ItemType.WAXED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:waxed_copper_trapdoor"))
            ...
            register(ItemType.WEATHERED_COPPER_DOOR, Identifier.fromString("minecraft:weathered_copper_door"))
            register(ItemType.WEATHERED_COPPER_GRATE, Identifier.fromString("minecraft:weathered_copper_grate"))
            ...
            register(ItemType.WHITE_CARPET, Identifier.fromString("minecraft:white_carpet"), ItemCarpet::class.java)
            ...
            register(ItemType.YELLOW_CARPET, Identifier.fromString("minecraft:yellow_carpet"), ItemCarpet::class.java)
