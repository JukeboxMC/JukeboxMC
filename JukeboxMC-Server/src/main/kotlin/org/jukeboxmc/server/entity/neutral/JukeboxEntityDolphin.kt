 ...
 * @version 1.0
 */
class JukeboxEntityDolphin : JukeboxEntityLiving(), Ageable {
    ...
    override fun getIdentifier(): Identifier {
        return Identifier.fromString("minecraft:dolphin")
    }

    override fun getHeight(): Float {
        return if (!this.isBaby()) 0.6f else 0.39f
    }

    override fun getWidth(): Float {
        return if (!this.isBaby()) 0.9f else 0.585f
    }
