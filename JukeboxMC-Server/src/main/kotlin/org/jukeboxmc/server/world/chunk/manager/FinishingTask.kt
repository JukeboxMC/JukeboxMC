...
class FinishingTask : BiFunction<JukeboxChunk, MutableList<JukeboxChunk>, JukeboxChunk> {
    ...
    override fun apply(chunk: JukeboxChunk, chunks: MutableList<JukeboxChunk>): JukeboxChunk {
        ...
        try {
            chunk.getWorld().getGenerator(chunk.getDimension()).finish(JukeboxPopulationChunkManager(chunk, chunks), chunk.getX(), chunk.getZ())
