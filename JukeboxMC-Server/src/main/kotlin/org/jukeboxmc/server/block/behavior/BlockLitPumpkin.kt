...
import org.jukeboxmc.api.block.LitPumpkin
...
class BlockLitPumpkin(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates), LitPumpkin {
   ...
   override fun setCardinalDirection(value: Direction): LitPumpkin {
