...
import org.jukeboxmc.api.block.WarpedStem
...
class BlockWarpedStem(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates), WarpedStem {
   ...
   override fun setPillarAxis(value: Axis): WarpedStem {
