...
import org.jukeboxmc.api.block.SoulTorch
...
class BlockSoulTorch(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates), SoulTorch {
   ...
   override fun setTorchFacingDirection(value: TorchFacing): SoulTorch {
