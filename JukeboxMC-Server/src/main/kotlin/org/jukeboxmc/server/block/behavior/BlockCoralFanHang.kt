...
import org.jukeboxmc.api.block.CoralFanHang
import org.jukeboxmc.api.block.data.Direction
import org.jukeboxmc.server.block.JukeboxBlock
import org.jukeboxmc.server.extensions.toByte

class BlockCoralFanHang(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates),
    CoralFanHang {
   ...
   override fun setCoralDirection(value: Direction): BlockCoralFanHang {
   ...
   override fun setCoralHangType(value: Boolean): BlockCoralFanHang {
   ...
   override fun setDead(value: Boolean): BlockCoralFanHang {
