...
import org.jukeboxmc.api.block.LargeAmethystBud
...
class BlockLargeAmethystBud(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates), LargeAmethystBud {
   ...
   override fun setBlockFace(value: BlockFace): LargeAmethystBud {
