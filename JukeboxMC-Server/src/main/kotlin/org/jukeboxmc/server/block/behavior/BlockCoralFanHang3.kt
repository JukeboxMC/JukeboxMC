...
import org.jukeboxmc.api.block.CoralFanHang3
import org.jukeboxmc.api.block.data.Direction
import org.jukeboxmc.server.block.JukeboxBlock
import org.jukeboxmc.server.extensions.toByte

class BlockCoralFanHang3(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates),
    CoralFanHang3 {
    ...
    override fun setCoralDirection(value: Direction): BlockCoralFanHang3 {
    ...
    override fun setCoralHangType(value: Boolean): BlockCoralFanHang3 {
    ...
    override fun setDead(value: Boolean): BlockCoralFanHang3 {
