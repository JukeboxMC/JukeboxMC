...
import org.jukeboxmc.api.block.Beehive
...
class BlockBeehive(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates),
    Beehive {
    ...
    override fun setDirection(value: Direction): Beehive {
        return when (value) {
    ...
    override fun setHoneyLevel(value: Int): BlockBeehive {
