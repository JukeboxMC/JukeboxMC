...
import org.jukeboxmc.api.block.Basalt
...
class BlockBasalt(identifier: Identifier, blockStates: NbtMap?) : JukeboxBlock(identifier, blockStates),
    Basalt {
    ...
    override fun setPillarAxis(value: Axis): BlockBasalt {
