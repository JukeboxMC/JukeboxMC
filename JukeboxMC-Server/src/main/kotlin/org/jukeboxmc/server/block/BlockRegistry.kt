...
class BlockRegistry {
    ...
    companion object {
        ...
        init {
            ...
            register(BlockType.TUFF_WALL, Identifier.fromString("minecraft:tuff_wall"), BlockWall::class.java)
            register(BlockType.TUFF_SLAB, Identifier.fromString("minecraft:tuff_slab"), BlockSlab::class.java)
            register(BlockType.POLISHED_TUFF_WALL, Identifier.fromString("minecraft:polished_tuff_wall"), BlockWall::class.java)
            register(BlockType.POLISHED_TUFF_STAIRS, Identifier.fromString("minecraft:polished_tuff_stairs"), BlockStairs::class.java)
            register(BlockType.POLISHED_TUFF_SLAB, Identifier.fromString("minecraft:polished_tuff_slab"), BlockSlab::class.java)
            register(BlockType.TUFF_BRICK_WALL, Identifier.fromString("minecraft:tuff_brick_wall"), BlockWall::class.java)
            register(BlockType.TUFF_BRICK_STAIRS, Identifier.fromString("minecraft:tuff_brick_stairs"), BlockStairs::class.java)
            register(BlockType.TUFF_BRICK_SLAB, Identifier.fromString("minecraft:tuff_brick_slab"), BlockSlab::class.java)
            register(BlockType.COPPER_DOOR, Identifier.fromString("minecraft:copper_door"), BlockDoor::class.java)
            register(BlockType.EXPOSED_COPPER_DOOR, Identifier.fromString("minecraft:exposed_copper_door"), BlockDoor::class.java)
            register(BlockType.WEATHERED_COPPER_DOOR, Identifier.fromString("minecraft:weathered_copper_door"), BlockDoor::class.java)
            register(BlockType.OXIDIZED_COPPER_DOOR, Identifier.fromString("minecraft:oxidized_copper_door"), BlockDoor::class.java)
            register(BlockType.WAXED_COPPER_DOOR, Identifier.fromString("minecraft:waxed_copper_door"), BlockDoor::class.java)
            register(BlockType.WAXED_EXPOSED_COPPER_DOOR, Identifier.fromString("minecraft:waxed_exposed_copper_door"), BlockDoor::class.java)
            register(BlockType.WAXED_WEATHERED_COPPER_DOOR, Identifier.fromString("minecraft:waxed_weathered_copper_door"), BlockDoor::class.java)
            register(BlockType.WAXED_OXIDIZED_COPPER_DOOR, Identifier.fromString("minecraft:waxed_oxidized_copper_door"), BlockDoor::class.java)
            register(BlockType.CHISELED_COPPER, Identifier.fromString("minecraft:chiseled_copper"))
            register(BlockType.EXPOSED_CHISELED_COPPER, Identifier.fromString("minecraft:exposed_chiseled_copper"))
            register(BlockType.WEATHERED_CHISELED_COPPER, Identifier.fromString("minecraft:weathered_chiseled_copper"))
            register(BlockType.OXIDIZED_CHISELED_COPPER, Identifier.fromString("minecraft:oxidized_chiseled_copper"))
            ...
            register(BlockType.COPPER_TRAPDOOR, Identifier.fromString("minecraft:copper_trapdoor"), BlockTrapdoor::class.java)
            register(BlockType.EXPOSED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:exposed_copper_trapdoor"), BlockTrapdoor::class.java)
            register(BlockType.WEATHERED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:weathered_copper_trapdoor"), BlockTrapdoor::class.java)
            register(BlockType.OXIDIZED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:oxidized_copper_trapdoor"), BlockTrapdoor::class.java)
            register(BlockType.WAXED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:waxed_copper_trapdoor"), BlockTrapdoor::class.java)
            register(BlockType.WAXED_EXPOSED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:waxed_exposed_copper_trapdoor"), BlockTrapdoor::class.java)
            register(BlockType.WAXED_WEATHERED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:waxed_weathered_copper_trapdoor"), BlockTrapdoor::class.java)
            register(BlockType.WAXED_OXIDIZED_COPPER_TRAPDOOR, Identifier.fromString("minecraft:waxed_oxidized_copper_trapdoor"), BlockTrapdoor::class.java)
