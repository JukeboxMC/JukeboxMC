...
dependencies {
    ...
    implementation("org.cloudburstmc.protocol:bedrock-codec:3.0.0.Beta1-JukeboxMC-SNAPSHOT") {
        exclude(group = "io.netty", module = "netty-common")
    }
    implementation("org.cloudburstmc:nbt:3.0.0.Final")
    implementation("org.cloudburstmc:block-state-updater:1.20.80.23-JukeboxMC-SNAPSHOT")
